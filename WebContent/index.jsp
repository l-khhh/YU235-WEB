...
<html>
	...
	<body>
		...
		<!-- Banner -->
			<div>
				<a href="#" class="image image-full"><img src="images/yu1.jpg" alt="" /></a>
			</div>
			...
			<section id="one" class="wrapper">
				<div class="inner flex flex-3">
					<div class="flex-item left">
						<div>
							<h3>웹 기능</h3>
							<p>웹을 통한 각 방의 특성 및 크기를 <br /> 설정할 수 있습니다.</p>
						</div>
						<div>
							<h3>App 기능</h3>
							<p>App를 통한 각 방의 특성 및 크기를<br /> 설정할 수 있습니다.</p>
						</div>
					</div>
					...
					<div class="flex-item right">
						<div>
							<h3>청소 내역 조회 기능</h3>
							<p>웹 또는 App를 통한 각 방의 청소 내역  <br />상태를 조회 할 수 있습니다..</p>
						</div>
						<div>
							<h3>타이머 기능</h3>
							<p>웹 또는 App를 통한 각 방의 청소 예약을<br /> 설정 할 수 있습니다..</p>
						</div>
					</div>
				</div>
			</section>
