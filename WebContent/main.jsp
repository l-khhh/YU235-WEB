...
<body>
		...
		<!-- Menu -->
			<nav id="menu">
				<ul class="links">
					...
					<li><a href="detail.html">제품설명서</a></li>
					<li><a href="main.jsp">청소 시작</a></li>
					<li><a href="people.html">제작자</a></li>
				</ul>
	...
	<div align="right">
			<input  type="button" value="방 등록" 
				...
				onclick="window.open('insert.html','사원추가하기','width=400, height=400, menubar=no, status=no, toolbar=no');"><br>
	</div>
	<div>
		<hr><br> <br>
	</div>
	...
	<table id="employee" border="1" width="300"
		...
		<%
			...
			try {
				...
				String sql = "select id, name from cleaning order by id"; // sql 쿼리 , id를 오름차순으로 전체 id와 name을 출력한다.
