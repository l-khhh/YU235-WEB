...
//
////oracle sql���� insert�� 2ȸ ����
////oracle sql���� insert�� �����͸� ���� update ����
////update���� ����� �����͸� mysql�� �������
////oracle sql���� insert&update�� �����͸� ����
//
//class DAOTest {
...
//		Class.forName("com.mysql.cj.jdbc.Driver");	// mysql �����ͺ��̽��� �����ϱ� ���� DriverManager�� ����Ѵ�.
//
//	}
//
//	
...
//			while (rset.next()) { // ����� �� �྿ ���ư��鼭 �����´�.
//				id=rset.getString("id");//String�� id��  db�� id�Ӽ��� ���� �����´�.
...
//				sal=rset.getString("sal");//String�� sal��  db�� sal�Ӽ��� ���� �����´�.
//			}
//			while (rset_mysql.next()) { // ����� �� �྿ ���ư��鼭 �����´�.
//				id_tmp=rset_mysql.getString("id");//String�� id��  db�� id�Ӽ��� ���� �����´�.
//				name_tmp=rset_mysql.getString("name");//String�� name��  db�� name�Ӽ��� ���� �����´�.
//				sex_tmp=rset_mysql.getString("sex");//String�� sex��  db�� sex�Ӽ����� �����´�.
//				position_tmp=rset_mysql.getString("position");//String�� position��  db�� position�Ӽ��� ���� �����´�.
//				dept_tmp=rset_mysql.getString("dept");//String�� dept��  db�� dept�Ӽ��� ���� �����´�.
//				sal_tmp=rset_mysql.getString("sal");//String�� sal��  db�� sal�Ӽ��� ���� �����´�.
//			}
//			conn.close();
//			conn_mysql.close();
//		} catch (SQLException e) {
